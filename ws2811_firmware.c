/* 
 * File:   ws2811_firmware_4550.c
 * Author: Liyanage Kalana Perera 
 *
 * Created on December 3, 2020, 08:20 AM
 */
...
#pragma config BOR = OFF        // Brown-out Reset Enable bits (Brown-out Reset disabled in haRBware and software)
...
#define _XTAL_FREQ 16000000 // Define Clock.
#include "ws2811_header.h"// Adding Custom WS2811 Header.
void main()
{
